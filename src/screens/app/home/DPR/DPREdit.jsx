...
//                 console.log(parsedDecryptedEquipmentListData?.data,"parsedDecryptedEquipmentListData?.data")
//               } else {
//                 showErrorMessage("Unable to get the Equipement Data List");
...
//         // Fetch crops for selected season
...
//                       onChangeText={(text) =>
//                         handleEquipmentChange("equipment", text)
//                       }
...
const DPREdit = ({ route, navigation }) => {
  ...
  const [showWorkTypeDropdown, setShowWorkTypeDropdown] = useState(false);
  const [showSeedClassDropdown, setShowSeedClassDropdown] = useState(false);
  const [showEquipmentDropdown, setShowEquipmentDropdown] = useState(false); // Added equipment dropdown state
